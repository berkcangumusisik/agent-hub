...
3. Summarize back, briefly:
   ...
   - Any `conventions` and `doNot` rules.
4. Hold this context for the session. When delegating, only invoke specialists listed in `team.active`, and pass them the relevant profile facts.
