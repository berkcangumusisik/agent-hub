...
const en: Dict = {
  ...
  "kicker.harness": "Harnesses",
  "kicker.cmd": "Commands",
  "harness.title": "Works with your harness",
  "harness.lead": "One team, installed into whatever AI coding tool you already use.",
  "harness.installs": "installs",
  "cmd.title": "Commands you'll use",
  "cmd.lead": "Slash-commands in Claude Code, or plain words in any harness that reads AGENTS.md.",
  "cmd.onboard": "Detect the stack and scaffold the profile",
  "cmd.team": "Show the roster and who's active here",
  "cmd.review": "Full-team review of your current diff",
  "cmd.decide": "Record a decision the team will honor",
  "cmd.handoff": "Summarize the state for the next session",
  "install.pick": "Pick your harness",
  "kicker.faq": "FAQ",
  "faq.title": "Questions",
  "faq.q1": "Do I have to fill the profile by hand?",
  "faq.a1": "No — run onboard and it detects your stack; you just confirm.",
  "faq.q2": "Does it work with my stack?",
  "faq.a2": "Yes, it's stack-agnostic — with 11 ready-made starter profiles to skip setup.",
  "faq.q3": "Can I use more than one harness?",
  "faq.a3": "Yes — install with 'all' and each tool gets its own file from one source.",
  "faq.q4": "Is it really free?",
  "faq.a4": "Yes. MIT-licensed, no telemetry, no account, no network calls except to your model.",
  ...
  "install.lead": "One line for any harness — then the team is ready in every project you open.",
...
const tr: Dict = {
  ...
  "hero.worksWith": "Şunlarla çalışır",
  ...
  "kicker.team": "Kadro",
  "kicker.harness": "Harness'lar",
  "kicker.cmd": "Komutlar",
  "harness.title": "Hangi aracı kullanırsan kullan",
  "harness.lead": "Tek ekip; zaten kullandığın hangi yapay zekâ aracıysa ona kurulur.",
  "harness.installs": "kurar",
  "cmd.title": "Kullanacağın komutlar",
  "cmd.lead": "Claude Code'da slash-komutları, AGENTS.md okuyan her harness'ta düz kelimeler.",
  "cmd.onboard": "Stack'i tespit edip profili oluşturur",
  "cmd.team": "Kadroyu ve burada aktif olanları gösterir",
  "cmd.review": "Mevcut diff'in tam ekip incelemesi",
  "cmd.decide": "Ekibin uyacağı kararı kaydeder",
  "cmd.handoff": "Sonraki oturum için durumu özetler",
  "install.pick": "Harness'ını seç",
  "kicker.faq": "SSS",
  "faq.title": "Sık sorulanlar",
  "faq.q1": "Profili elle mi doldurmam gerek?",
  "faq.a1": "Hayır — onboard çalıştır, stack'ini tespit eder; sen sadece onaylarsın.",
  "faq.q2": "Benim stack'imle çalışır mı?",
  "faq.a2": "Evet, stack bağımsız — kurulumu atlamak için 11 hazır profille.",
  "faq.q3": "Birden fazla harness kullanabilir miyim?",
  "faq.a3": "Evet — 'all' ile kur, her araç tek kaynaktan kendi dosyasını alır.",
  "faq.q4": "Gerçekten ücretsiz mi?",
  "faq.a4": "Evet. MIT lisanslı, telemetri yok, hesap yok, modelin dışında ağ çağrısı yok.",
  ...
  "install.lead": "Her harness için tek satır — sonrasında açtığın her projede ekip hazır.",
